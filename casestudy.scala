...
val defaultMoviesUrl = "https://casestudystorageaccount.blob.core.windows.net/data/movies.csv"
val defaultRatingsUrl = "adl://casestudydatalakestore.azuredatalakestore.net/data/ratings.csv"
...
spark.conf.set("dfs.adls.oauth2.client.id", "d5f2a7ff-f0e8-49e6-8f6b-2a1ab942785f")
spark.conf.set("dfs.adls.oauth2.credential", "1MXrNUfkZ/zU6pZ37bM/RyiAy6enarbBBUeVxUIMeVc=")
...
val ratingsData = sc.textFile("adl://casestudydatalakestore.azuredatalakestore.net/data/ratings.csv")
